...
Функция НачатьСоздание(ИмяМетаданных) Экспорт
	...
	НовыйОбъект.ПараметрыОбъектаСлужебный.Вставить("ДополнительныеСвойства", Новый Структура);
...
Функция ДополнительноеСвойство(ИмяСвойства, Значение = Неопределено) Экспорт
	
	ПараметрыОбъектаСлужебный.ДополнительныеСвойства.Вставить(ИмяСвойства, Значение);
	Возврат ЭтотОбъект;
...
Функция ВыполнитьАвтозаполнениеПараметров(Знач ТипОбъекта, Знач ВидОбъекта, ПараметрыЭлемента) 
	...
	Для каждого КлючЗначение Из ПараметрыЭлемента Цикл
		...
		Если ИмяРеквизита = "ДополнительныеСвойства" Или ИмяРеквизита = "AdditionalProperties" Тогда
			Продолжить;
		КонецЕсли;
...
Функция СоздатьЭлементСправочникаСлужебный(ИмяСправочника, ПараметрыЭлемента = Неопределено) 
	...
	Если ПараметрыЭлемента.Свойство("ДополнительныеСвойства") Тогда
		
		ДополнитьСтруктуру(Элемент.ДополнительныеСвойства, ПараметрыЭлемента.ДополнительныеСвойства, Истина);
...
Функция СоздатьДокументСлужебный(ИмяДокумента, ПараметрыДокумента = Неопределено, ОбработчикиСтрокТЧ = Неопределено) 
	...
	Если ПараметрыДокумента.Свойство("ДополнительныеСвойства") Тогда
		
		ДополнитьСтруктуру(Документ.ДополнительныеСвойства, ПараметрыДокумента.ДополнительныеСвойства, Истина);
